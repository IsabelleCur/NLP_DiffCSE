...
from diffcse.models import RobertaForCL, BertForCL, DistillForCL
...
def main():
    ...
    if model_args.model_name_or_path:
        if 'distil' in model_args.model_name_or_path:
            ...
            model.discriminator.load_state_dict(pretrained_model.distilbert.state_dict(), strict=False)
    ...
    def prepare_features(examples):
        ...
        if sent2_cname is not None:
            ...
            for key in sent_features:
                ...
                # ===Ablation Study 2: Next Sentence===
                # features[key] = [[sent_features[key][i], sent_features[key][i+total+1]] for i in range(total-1)]
        return features
